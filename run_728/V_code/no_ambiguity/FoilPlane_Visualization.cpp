...
void FoilPlane_Visualization()
{
	...
	grY[0]->GetYaxis()->SetTitleOffset(1.5);
	...
	grY[0]->GetXaxis()->SetTitleOffset(20);
	...
	for(int SRC_NO_i=1; SRC_NO_i<14; SRC_NO_i++)
	{
		...
		grY[SRC_NO_i]->SetMarkerSize(1.5);
	...
	CY->Print("vY.png");
        ...
        grZ[0]->GetYaxis()->SetTitleOffset(1.5);
        ...
        for(int SRC_NO_i=1; SRC_NO_i<14; SRC_NO_i++)
        {
                ...
                grZ[SRC_NO_i]->SetMarkerSize(1.5);
        ...
        hZ->GetXaxis()->SetTitleOffset(1.5);

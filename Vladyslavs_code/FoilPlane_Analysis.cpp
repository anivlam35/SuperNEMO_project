...
void FoilPlane_Analysis()
{
	TFile* file = new TFile("FoilPlane_Tracks.root");
	// TFile* file = new TFile("Clear_data.root");
	
	TFile *New_file = new TFile("Clear_data.root","RECREATE"); // MIRO: TO RENAME AND PLAN BETTER THE CONTENTS!new root file for received histograms
